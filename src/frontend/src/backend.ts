...
import type { AcceptanceRecord as _AcceptanceRecord, Time as _Time } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async getAcceptanceCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getAcceptanceCount();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getLatestRecord(): Promise<AcceptanceRecord> {
        if (this.processError) {
            try {
                const result = await this.actor.getLatestRecord();
                return from_candid_AcceptanceRecord_n1(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async recordAcceptance(arg0: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordAcceptance(to_candid_opt_n4(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_AcceptanceRecord_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AcceptanceRecord): AcceptanceRecord {
...
function from_candid_record_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        note: record_opt_to_undefined(from_candid_opt_n3(_uploadFile, _downloadFile, value.note)),
